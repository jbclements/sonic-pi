...
Here's an example of getting something to make some sound.

First, you already installed this package, right?

Second, you're going to need to start the synthesis engine. It's not
unreasonable to expect this code to start the synthesis engine itself...
